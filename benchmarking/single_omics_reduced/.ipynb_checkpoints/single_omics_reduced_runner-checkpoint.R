...
#SBATCH -o sor_experiment_noise_jpivot_missing_ipivot_lasso_benchmark_output.txt
#SBATCH -e sor_experiment_noise_jpivot_missing_ipivot_lasso_benchmark_error.txt
...
R CMD BATCH '--args input=","\"/home/icb/juan.henao/lasso_benchmark/input_data/090322_single_omics_benchmark.RData\""," cores=10  bench_params=white' single_omics_reduced_kimono_runner.R")
...
tmp <- gsub(pattern = "ipivot",replacement = i,x = tmp)
    #print(tmp)
file_name <- paste0("sor_experiment_noise_",j,"_missing_",i,".sh")
