...
#SBATCH -o mos_experiment_noise_jpivot_missing_ipivot_lasso_benchmark_output.txt
#SBATCH -e mos_experiment_noise_jpivot_missing_ipivot_lasso_benchmark_error.txt
...
R CMD BATCH '--args input=","\"/home/icb/juan.henao/lasso_benchmark/input_data/090322_multi_omics_benchmark.RData\""," cores=10  bench_params=white' multi_omics_sample_kimono_runner.R")
...
tmp <- gsub(pattern = "ipivot",replacement = i,x = tmp)
    #print(tmp)
file_name <- paste0("mos_experiment_noise_",j,"_missing_",i,".sh")
